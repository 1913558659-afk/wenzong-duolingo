...
import { BookOpen, Brain, CalendarDays, ClipboardList, Compass, Crown, Home, LibraryBig, LogIn, LogOut, Map, Menu, Palmtree, PawPrint, PenSquare, Shield, UserRound, X } from "lucide-react";
